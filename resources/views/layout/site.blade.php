...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="/site/assets/imgs/theme/favicon.svg">
    <!-- Template CSS -->
    <link rel="stylesheet" href="/site/assets/css/main.css?v=3.4">
...
<body>
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <div class="detail-gallery">
                                ...
                                <div class="product-image-slider">
                                    <figure class="border-radius-10">
                                        <img src="/site/assets/imgs/shop/product-16-2.jpg" alt="product image">
                                    </figure>
                                    <figure class="border-radius-10">
                                        <img src="/site/assets/imgs/shop/product-16-1.jpg" alt="product image">
                                    </figure>
                                    <figure class="border-radius-10">
                                        <img src="/site/assets/imgs/shop/product-16-3.jpg" alt="product image">
                                    </figure>
                                    <figure class="border-radius-10">
                                        <img src="/site/assets/imgs/shop/product-16-4.jpg" alt="product image">
                                    </figure>
                                    <figure class="border-radius-10">
                                        <img src="/site/assets/imgs/shop/product-16-5.jpg" alt="product image">
                                    </figure>
                                    <figure class="border-radius-10">
                                        <img src="/site/assets/imgs/shop/product-16-6.jpg" alt="product image">
                                    </figure>
                                    <figure class="border-radius-10">
                                        <img src="/site/assets/imgs/shop/product-16-7.jpg" alt="product image">
                                    </figure>
                                </div>
                                <!-- THUMBNAILS -->
                                <div class="slider-nav-thumbnails pl-15 pr-15">
                                    <div><img src="/site/assets/imgs/shop/thumbnail-3.jpg" alt="product image"></div>
                                    <div><img src="/site/assets/imgs/shop/thumbnail-4.jpg" alt="product image"></div>
                                    <div><img src="/site/assets/imgs/shop/thumbnail-5.jpg" alt="product image"></div>
                                    <div><img src="/site/assets/imgs/shop/thumbnail-6.jpg" alt="product image"></div>
                                    <div><img src="/site/assets/imgs/shop/thumbnail-7.jpg" alt="product image"></div>
                                    <div><img src="/site/assets/imgs/shop/thumbnail-8.jpg" alt="product image"></div>
                                    <div><img src="/site/assets/imgs/shop/thumbnail-9.jpg" alt="product image"></div>
                                </div>
                            </div>
                            <!-- End Gallery -->
                            <div class="social-icons single-share">
                                <ul class="text-grey-5 d-inline-block">
                                    ...
                                    <li class="social-facebook"><a href="#"><img src="/site/assets/imgs/theme/icons/icon-facebook.svg" alt=""></a></li>
                                    <li class="social-twitter"> <a href="#"><img src="/site/assets/imgs/theme/icons/icon-twitter.svg" alt=""></a></li>
                                    <li class="social-instagram"><a href="#"><img src="/site/assets/imgs/theme/icons/icon-instagram.svg" alt=""></a></li>
                                    <li class="social-linkedin"><a href="#"><img src="/site/assets/imgs/theme/icons/icon-pinterest.svg" alt=""></a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            ...
                            <ul>
                                <li>
                                    ...
                                    <ul class="language-dropdown">
                                        <li><a href="#"><img src="/site/assets/imgs/theme/flag-fr.png" alt="">Français</a></li>
                                        <li><a href="#"><img src="/site/assets/imgs/theme/flag-dt.png" alt="">Deutsch</a></li>
            ...
            <div class="container">
                <div class="header-wrap">
                    <div class="logo logo-width-1">
                        <a href="index.html"><img src="/site/assets/imgs/theme/logo.svg" alt="logo"></a>
                    </div>
                                        ...
                                        <ul>
                                            <li>
                                                <div class="shopping-cart-img">
                                                    <a href="shop-product-right.html"><img alt="Evara" src="/site/assets/imgs/shop/thumbnail-3.jpg"></a>
                                                </div>
                                            ...
                                            <li>
                                                <div class="shopping-cart-img">
                                                    <a href="shop-product-right.html"><img alt="Evara" src="/site/assets/imgs/shop/thumbnail-2.jpg"></a>
                                                </div>
                                                <div class="shopping-cart-title">
                                            ...
                                            <ul class="mega-menu d-lg-flex">
                                                ...
                                                <li class="mega-menu-col col-lg-5">
                                                    <div class="header-banner2">
                                                        <img src="/site/assets/imgs/banner/menu-banner-2.jpg" alt="menu_banner1">
                                                    ...
                                                    <div class="header-banner2">
                                                        <img src="/site/assets/imgs/banner/menu-banner-3.jpg" alt="menu_banner2">
                                                        <div class="banne_info">
                                                            <h6>15% Off</h6>
                                                            <h4>Hot Deals</h4>
                                                            <a href="#">Shop now</a>
                                    ...
                                    <li class="has-children">
                                        ...
                                        <div class="dropdown-menu">
                                            <ul class="mega-menu d-lg-flex">
                                                ...
                                                <li class="mega-menu-col col-lg-5">
                                                    <div class="header-banner2">
                                                        <img src="/site/assets/imgs/banner/menu-banner-4.jpg" alt="menu_banner1">
                                                        <div class="banne_info">
                                                            <h6>10% Off</h6>
                                                            <h4>New Arrival</h4>
                                                            <a href="#">Shop now</a>
                                    ...
                                    <li class="has-children">
                                        ...
                                        <div class="dropdown-menu">
                                            <ul class="mega-menu d-lg-flex">
                                                ...
                                                <li class="mega-menu-col col-lg-5">
                                                    <div class="header-banner2">
                                                        <img src="/site/assets/imgs/banner/menu-banner-5.jpg" alt="menu_banner1">
                                                        <div class="banne_info">
                                                            <h6>10% Off</h6>
                                                            <h4>New Arrival</h4>
                                                            <a href="#">Shop now</a>
                                                    ...
                                                    <div class="header-banner2">
                                                        <img src="/site/assets/imgs/banner/menu-banner-6.jpg" alt="menu_banner2">
                                                        <div class="banne_info">
                                                            <h6>15% Off</h6>
                                                            <h4>Hot Deals</h4>
                                                            <a href="#">Shop now</a>
                                        ...
                                        <ul class="mega-menu">
                                            ...
                                            <li class="sub-mega-menu sub-mega-menu-width-34">
                                                <div class="menu-banner-wrap">
                                                    <a href="shop-product-right.html"><img src="/site/assets/imgs/banner/menu-banner.jpg" alt="Evara"></a>
                            ...
                            <div class="header-action-icon-2">
                                ...
                                <div class="cart-dropdown-wrap cart-dropdown-hm2">
                                    <ul>
                                        ...
                                        <li>
                                            <div class="shopping-cart-img">
                                                <a href="shop-product-right.html"><img alt="Evara" src="/site/assets/imgs/shop/thumbnail-4.jpg"></a>
                                            </div>
                                            <div class="shopping-cart-title">
        ...
        <div class="mobile-header-wrapper-inner">
            ...
            <div class="mobile-header-content-area">
                ...
                <div class="mobile-social-icon">
                    ...
                    <a href="#"><img src="/site/assets/imgs/theme/icons/icon-facebook.svg" alt=""></a>
                    <a href="#"><img src="/site/assets/imgs/theme/icons/icon-twitter.svg" alt=""></a>
                    <a href="#"><img src="/site/assets/imgs/theme/icons/icon-instagram.svg" alt=""></a>
                    <a href="#"><img src="/site/assets/imgs/theme/icons/icon-pinterest.svg" alt=""></a>
                    <a href="#"><img src="/site/assets/imgs/theme/icons/icon-youtube.svg" alt=""></a>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="col-lg-7 mb-md-3 mb-lg-0">
                        <div class="row align-items-center">
                            <div class="col flex-horizontal-center">
                                <img class="icon-email" src="/site/assets/imgs/theme/icons/icon-email.svg" alt="">
                        ...
                        <div class="row">
                            <div class="col-md-8 col-lg-12">
                                ...
                                <div class="download-app wow fadeIn animated">
                                    <a href="#" class="hover-up mb-sm-4 mb-lg-0"><img class="active" src="/site/assets/imgs/theme/app-store.jpg" alt=""></a>
                                    <a href="#" class="hover-up"><img src="/site/assets/imgs/theme/google-play.jpg" alt=""></a>
                                </div>
                            </div>
                            <div class="col-md-4 col-lg-12 mt-md-3 mt-lg-0">
                                <p class="mb-20 wow fadeIn animated">Secured Payment Gateways</p>
                                <img class="wow fadeIn animated" src="/site/assets/imgs/theme/payment-method.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script src="/site/assets/js/vendor/bootstrap.bundle.min.js"></script>
    <script src="/site/assets/js/plugins/slick.js"></script>
    <script src="/site/assets/js/plugins/jquery.syotimer.min.js"></script>
    <script src="/site/assets/js/plugins/wow.js"></script>
    <script src="/site/assets/js/plugins/jquery-ui.js"></script>
    <script src="/site/assets/js/plugins/perfect-scrollbar.js"></script>
    <script src="/site/assets/js/plugins/magnific-popup.js"></script>
    <script src="/site/assets/js/plugins/select2.min.js"></script>
    <script src="/site/assets/js/plugins/waypoints.js"></script>
    <script src="/site/assets/js/plugins/counterup.js"></script>
    <script src="/site/assets/js/plugins/jquery.countdown.min.js"></script>
    <script src="/site/assets/js/plugins/images-loaded.js"></script>
    <script src="/site/assets/js/plugins/isotope.js"></script>
    <script src="/site/assets/js/plugins/scrollup.js"></script>
    <script src="/site/assets/js/plugins/jquery.vticker-min.js"></script>
