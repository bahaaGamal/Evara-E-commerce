    ...
    <aside class="navbar-aside" id="offcanvas_aside">
        ...
        <nav>
            <ul class="menu-aside">
                ...
                <li class="menu-item">
                    <a class="menu-link" href="{{ route('sellers.index') }}"> <i class="icon material-icons md-stars"></i>
                        <span class="text">Sellers</span> </a>
                </li>
                <li class="menu-item">
                    <a class="menu-link" href="{{Route('products.create')}}"> <i class="icon material-icons md-comment"></i>
                ...
                <li class="menu-item">
                    <a class="menu-link" href="{{ route('brands.index') }}"> <i class="icon material-icons md-stars"></i>
                ...
                <ul class="nav">
                    ...
                    <li class="dropdown nav-item">
                        <a class="dropdown-toggle" data-bs-toggle="dropdown" href="#" id="dropdownAccount" aria-expanded="false">
                            {{Auth::guard('seller')->user()->manager_name}}
                        </a>
                        <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownAccount">
                            ...
                            <a class="dropdown-item text-danger" href="{{Route('seller.logout')}}"><i class="material-icons md-exit_to_app"></i>Logout</a>
                        </div>
                    </li>
                </ul>
            </div>
